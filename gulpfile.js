...
const watcher = () => {
  ...
  gulp.watch(path.pngSprite.watch, pngSprite).on('all', browserSync.reload);
...
const build = gulp.series(clear, gulp.parallel(html, sass, js, img, fonts, svg, video, svgSprite, pngSprite, favicon, php)); // html || pug || njk
